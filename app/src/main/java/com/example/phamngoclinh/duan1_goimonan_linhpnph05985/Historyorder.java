...
import com.example.phamngoclinh.duan1_goimonan_linhpnph05985.adapter.HistoryorderAdapter;
...
public class Historyorder extends Fragment {
    ...
    private HistoryorderAdapter bookAdapter;
    private ArrayList<Historyordermodel> bookArrayList;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        layoutHome = inflater.inflate(R.layout.historyorder,container,false);
        recycler();
        return layoutHome;
    }
    public void recycler(){
        recyclerviewBook = layoutHome.findViewById(R.id.recyclerh);
        linearLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);

        bookArrayList = new ArrayList<>();
        bookArrayList.add(new Historyordermodel("1","1","546546546"));
        bookArrayList.add(new Historyordermodel("1","1","546546546"));
        bookArrayList.add(new Historyordermodel("1","1","546546546"));
        bookArrayList.add(new Historyordermodel("1","1","546546546"));
        bookArrayList.add(new Historyordermodel("1","1","546546546"));
        ...
        bookAdapter=new HistoryorderAdapter(bookArrayList, getActivity());
